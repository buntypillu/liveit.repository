...
# ----------------------------------------------------------
    def add(self, rootFolder=None):
        menuItems = ["Add folder", "Add Live!t TV Web item", "Add xbmc favourite"]
        ...
        if select == 0:
            ...
            common.showInfo('Please browse through Live!t TV Web and use \ncontext menu entry "Add to Live!t TV Web favourites"')
        elif select == 2:
