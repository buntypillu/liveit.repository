...
class Main:
    ...
    def __init__(self):
        ...
        common.log('Live!t TV Web initialized')
        ...
        if definedIn:
            ...
            if definedIn.endswith('favourites.cfg') or definedIn.startswith("favfolders/"):
                ...
                if lItem['title'] != "Favourites":
                        # Add to favourites
                        contextMenuItem = createContextMenuItem('Add to Live!t TV Web favourites', Mode.ADDTOFAVOURITES, codedItem)
                        contextMenuItems.append(contextMenuItem)
    ...
    def queueAllVideos(self, item):
        dia = DialogProgress()
        dia.create('Live!t TV Web', 'Get videos...' + item['title'])
        dia.update(0)
    ...
    def run(self, argv=None):
        self.addon = Addon('plugin.video.LiveitWeb', argv)
        common.log('Live!t TV Web running')
        ...
        try:
            ...
            common.showError('Error running Live!t TV Web')
            common.log('Error running Live!t TV Web. Reason:' + str(e))
